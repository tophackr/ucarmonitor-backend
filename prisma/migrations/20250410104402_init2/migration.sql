...
-- CreateEnum
CREATE TYPE "InteractionCategory" AS ENUM ('mileage', 'parking', 'toll_road', 'taxi', 'sober_driver', 'alarm_system', 'fuel', 'wash', 'maintenance', 'tire_service', 'repair', 'parts', 'purchase_tires', 'tow_truck', 'insurance', 'tax', 'state_inspection', 'fine', 'car_purchase', 'loan_repayment', 'leasing', 'car_purchases', 'tuning', 'driver_salary');
...
CREATE TABLE "car" (
    ...
    "odometer_units" "OdometerUnits" NOT NULL,
    "engine_hours_enabled" BOOLEAN NOT NULL,
...
CREATE TABLE "fuel_interaction" (
    ...
    CONSTRAINT "fuel_interaction_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "wheel_interaction" (
    ...
    CONSTRAINT "wheel_interaction_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "part_on_interaction" ADD CONSTRAINT "part_on_interaction_interactionId_fkey" FOREIGN KEY ("interactionId") REFERENCES "interaction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "part_on_interaction" ADD CONSTRAINT "part_on_interaction_partId_fkey" FOREIGN KEY ("partId") REFERENCES "part"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "repair_on_interaction" ADD CONSTRAINT "repair_on_interaction_interactionId_fkey" FOREIGN KEY ("interactionId") REFERENCES "interaction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "repair_on_interaction" ADD CONSTRAINT "repair_on_interaction_repairId_fkey" FOREIGN KEY ("repairId") REFERENCES "repair"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
